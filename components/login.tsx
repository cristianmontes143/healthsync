...
const Login = () => {
    return (
        <div className='flex items-center justify-center h-screen rgba(35, 164, 221, 0.7599999905)'>
            <Card className='w-[500px]' style={{ backgroundColor: 'rgba(35, 164, 221, 0.7599999905)' }}>
                <CardHeader>
